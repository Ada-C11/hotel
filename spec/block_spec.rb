...
describe "Block class" do
  describe "initialize" do
    it "returns a block object" do
      block_id = 12
      room_ids = [1, 2, 3]
      reserved_dates = Hotel::Time_Interval.new(Date.parse("2019-12-03"), Date.parse("2019-12-04"))
      discounted_rate = 180
      expect(Hotel::Block.new(block_id, room_ids, reserved_dates, discounted_rate)).must_be_instance_of Hotel::Block
    end

    it "raises an argument error when more than 5 rooms are blocked out" do
      block_id = 12
