...
describe HotelGroup::CsvRecord do
  describe "constructor" do
    it "takes and saves an id" do
      id = 7
      record = HotelGroup::CsvRecord.new(id)
  ...
  describe "load_all" do
    ...
    it "raises an error if invoked directly (without subclassing)" do
      ...
      expect {
        HotelGroup::CsvRecord.load_all(full_path: full_path)
  ...
  describe "validate_id" do
    it "accepts natural numbers" do
      ...
      [1, 10, 9999].each do |id|
        HotelGroup::CsvRecord.validate_id(id)
      end
    end
    ...
    it "raises for nil" do
      expect {
        HotelGroup::CsvRecord.validate_id(nil)
      }.must_raise ArgumentError
    end
  end
  ...
  describe "extension" do
    ...
    class TestRecord < HotelGroup::CsvRecord
      attr_reader :name
    ...
    describe "load_all" do
      let(:record_count) {
        %x{wc -l 'spec/test_data/testrecords.csv'}.split(" ").first.to_i - 1
      }
      ...
      it "finds data given a full path" do
        path = "spec/test_data/custom_filename_test.csv"
      ...
      it "calls `from_csv` for each record in the file" do
        TestRecord.load_all(directory: "spec/test_data")
