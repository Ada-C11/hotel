...
describe "Unavailable class" do
  ...
  describe "Unavailable#valid_date_range?" do
    it "check_in is before check_out" do
      expect(valid_unavailable.valid_date_range?(date1, date2)).must_equal true
    end

    it "check_in is same as end" do
      expect(valid_unavailable.valid_date_range?(date2, date2)).must_equal false
    end

    it "check_in is before today" do
      expect(valid_unavailable.valid_date_range?(past, date1)).must_equal false
    end
  end
end
