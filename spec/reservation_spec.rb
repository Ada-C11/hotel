...
describe "Reservation class" do
  describe "Initialize" do
    ...
    it "establishes the base data structures when instantiated" do
       @reservation = Hotel::Reservation.new(id: 1, 
                                            room: 5, 
                                            start_date:"2019-1-1",
                                            end_date:"2019-1-10",)
...
describe "date range methods" do
  before do
   @reservation = Hotel::Reservation.new(id: 10, 
                                            room: 15, 
  ...
  it "correctly transforms the given string date to an instance of Date" do
    @reservation2 = Hotel::Reservation.new(id: 11, room: 1, start_date:"20190101", end_date: "02-11-2019")
