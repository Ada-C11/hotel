...
describe 'BookingCentral' do
  ...
  describe 'overbooking scenarios' do
    it 'does not overbook a room' do
      ...
      expect{(new_booking = booker.reserve_room(check_in: '2019-01-03', check_out: '2019-01-04', room: assign_room(check_in, check_out)).room)}.wont_equal 1
    end

    it 'rejects hotel overbooking' do
      booker = BookingCentral.new
      expect{21.times{booker.reserve_room(check_in: '2019-01-03', check_out: '2019-01-04', room: booker.assign_room('2019-01-03', '2019-01-04'))}}.must_raise ArgumentError
    end
  end
end