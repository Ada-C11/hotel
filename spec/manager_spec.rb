...
describe "Manager Spec" do
  ...
  describe "Room Availability" do
    ...
    let (:res2) {
      ...
      check_out2 = Date.new(2019, 06, 10)
      room8 = 8
      res2 = this_manager.make_res_for_room(check_in2, check_out2, room8)
    }
    ...
    let (:res3) {
      ...
      room1 = 1
      res3 = this_manager.make_res_for_room(check_in3, check_out3, room1)
    }
    ...
    let (:res4) {
      ...
      room1 = 1
      res4 = this_manager.make_res_for_room(check_in4, check_out4, room1)
    }
    ...
    let (:res5_overlap) {
      ...
      room1 = 1
      res_test_same_date = this_manager.make_res_for_room(check_in_test, check_out_test, room1)
    }
    ...
    let (:res6_overlap_start) {
      ...
      room1 = 1
      res_test_same_date = this_manager.make_res_for_room(check_in6, check_out6, room1)
    }
    ...
    let (:res7_overlap_end) {
      ...
      room1 = 1
      res_test_same_date = this_manager.make_res_for_room(check_in7, check_out7, room1)
    }
