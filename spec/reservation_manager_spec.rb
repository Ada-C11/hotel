...
describe "Reservation_manager" do
  ...
  describe "make_reservation" do
    ...
    it "adds reservations to list of reservations" do
      new_rez_man.make_reservation(reservation_id: 1, check_in_time: "3rd April 2019", check_out_time: "10th April 2019")
      new_rez_man.make_reservation(reservation_id: 2, check_in_time: "11th April 2019", check_out_time: "2nd May 2019")
  ...
  describe "find_reservation" do
    it "returns an array of reservations" do
      new_rez_man.make_reservation(reservation_id: 1, check_in_time: "3rd April 2019", check_out_time: "10th April 2019")
      new_rez_man.make_reservation(reservation_id: 2, check_in_time: "11th April 2019", check_out_time: "2nd May 2019")
      new_rez_man.make_reservation(reservation_id: 7, check_in_time: "22nd March 2019", check_out_time: "5th April 2019")
  ...
  describe "find_available_room method" do
    it "should return an array with length equal to number of rooms available" do
      new_rez_man.make_reservation(check_in_time: "2nd April 2019", check_out_time: "10th April 2019")
      # # => should not work
      new_rez_man.make_reservation(check_in_time: "4th april 2019", check_out_time: "20th april 2019")
      # # => should work
      new_rez_man.make_reservation(check_in_time: "22nd march 2019", check_out_time: "1st april 2019")
      # # => should work
      expect(new_rez_man.find_available_rooms("1st April 2019", "4th April 2019").length).must_equal 19
