...
describe "Reservation_manager" do
  ...
  describe "find_available_room method" do
    let(:res_four) {
      res_manager.make_reservation(4, check_in_time: "22nd March 2019", check_out_time: "1st April 2019")
    }

    let(:res_five) {
      res_manager.make_reservation(5, check_in_time: "4th April 2019", check_out_time: "20th April 2019")
    }
    let(:find_rooms_one) {
  ...
  describe "make_reservation_from_block method" do
    ...
    it "if reservation is part of a block, it must have the same dates as the block" do
      ...
      expect(block_res_seven.check_in_time).must_equal Date.parse("7th June 2020")
    end
