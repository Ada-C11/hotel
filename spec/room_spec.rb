...
describe "Room class" do
  ...
  describe "get_reservation_on_date method" do
    it "returns an accurate reservations for a specified date" do
      ...
      room.reserve(Hotel::TimeInterval.new(Date.parse("2019-03-25"), Date.parse("2019-03-29")))
  ...
  describe "is_available method" do
    before do
      ...
      @room.reserve(Hotel::TimeInterval.new(Date.parse("2019-03-25"), Date.parse("2019-03-29")))
      @room.reserve(Hotel::TimeInterval.new(Date.parse("2019-03-20"), Date.parse("2019-03-23")))
      @room.block_dates(Hotel::TimeInterval.new(Date.parse("2019-04-20"), Date.parse("2019-04-25")))
      @room.block_dates(Hotel::TimeInterval.new(Date.parse("2019-05-01"), Date.parse("2019-05-05")))
    end

    it "returns true when a room is available for a given period" do
      @room.is_available?(Hotel::TimeInterval.new(Date.parse("2019-03-23"), Date.parse("2019-03-24"))).must_equal true
    end

    it "returns false when a room is unavailable for a given period" do
      @room.is_available?(Hotel::TimeInterval.new(Date.parse("2019-03-20"), Date.parse("2019-03-21"))).must_equal false
    end

    it "returns true when a room block is available for a given period" do
      @room.is_available?(Hotel::TimeInterval.new(Date.parse("2019-04-25"), Date.parse("2019-04-30"))).must_equal true
    end

    it "returns false when a room block is unavailable for a given period" do
      @room.is_available?(Hotel::TimeInterval.new(Date.parse("2019-04-20"), Date.parse("2019-04-25"))).must_equal false
    end
  end
  ...
  describe "reserve_block method" do
    ...
    it "removes the reserved dates from the block_intervals list" do
      duration_one = Hotel::TimeInterval.new(Date.parse("2019-10-14"), Date.parse("2019-10-18"))
      duration_two = Hotel::TimeInterval.new(Date.parse("2019-11-14"), Date.parse("2019-11-18"))
      discount_rate = 180
  ...
  describe "block_dates method" do
    ...
    it "adds a new date range into the block intervals" do
      duration = Hotel::TimeInterval.new(Date.parse("2019-10-14"), Date.parse("2019-10-18"))
    ...
    it "throws an exception if the reserved dates overlap with the existing blocked out dates" do
      duration_one = Hotel::TimeInterval.new(Date.parse("2019-10-14"), Date.parse("2019-10-18"))
      duration_two = Hotel::TimeInterval.new(Date.parse("2019-10-15"), Date.parse("2019-10-20"))
      room.block_dates(duration_one)
